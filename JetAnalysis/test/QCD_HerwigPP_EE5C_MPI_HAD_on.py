...
#    annotation = cms.untracked.string('Configuration/GenProduction/python/2760GeV/MinBias_TuneEE3C_2760GeV_herwigpp_cff.py nevts:500000'),
...
def customise(process):
	...
	process.rivetAnalyzer.CrossSection = cms.double(6.617e+08)
